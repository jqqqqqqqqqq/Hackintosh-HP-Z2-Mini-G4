 ...
 *
 * Disassembly of ssdt5.aml, Tue Aug  4 03:47:23 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000030ED (12525)
 *     Revision         0x02
 *     Checksum         0x58
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    External (_SB_.PCI0.GFX0.HDOD, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.GFX0.HDOS, MethodObj)    // 1 Arguments (from opcode)
    ...
    OperationRegion (SANV, SystemMemory, 0xB3B14018, 0x01F4)
